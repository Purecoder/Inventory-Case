...
#pragma region Windows Form Designer generated code
	...
	void InitializeComponent(void)
	{
		...
		// txtQuantity
		// 
		this->txtQuantity->Location = System::Drawing::Point(219, 167);
		...
		// txtUnitPrice
		// 
		this->txtUnitPrice->Location = System::Drawing::Point(219, 210);
		...
		this->lblItemName->Size = System::Drawing::Size(71, 20);
		this->lblItemName->TabIndex = 7;
		this->lblItemName->Text = L"Ürün Adý";
		// 
		// label1
		// 
		...
		this->label2->Location = System::Drawing::Point(98, 173);
		this->label2->Name = L"label2";
		this->label2->Size = System::Drawing::Size(87, 20);
		this->label2->TabIndex = 9;
		this->label2->Text = L"Stok Sayýsý";
		// 
		// label3
		// 
		this->label3->AutoSize = true;
		this->label3->Location = System::Drawing::Point(98, 216);
		this->label3->Name = L"label3";
		this->label3->Size = System::Drawing::Size(46, 20);
		this->label3->TabIndex = 10;
		this->label3->Text = L"Fiyatý";
		// 
		// btnAddItem
		// 
		this->btnAddItem->Location = System::Drawing::Point(219, 283);
		this->btnAddItem->Name = L"btnAddItem";
		this->btnAddItem->Size = System::Drawing::Size(135, 64);
		this->btnAddItem->TabIndex = 11;
		this->btnAddItem->Text = L"Kaydet";
		this->btnAddItem->UseVisualStyleBackColor = true;
		this->btnAddItem->Click += gcnew System::EventHandler(this, &AddItemForm::btnAddItem_Click);
		// 
		// AddItemForm
		// 
...
private: System::Void AddItemForm_Load(System::Object^ sender, System::EventArgs^ e) {
	...
	//	comboBox1->Items->Add(category); // Kategori adýný ekle
	//}
}
private: System::Void btnAddItem_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	newItem->Quantity = Int32::Parse(txtQuantity->Text);
	newItem->UnitPrice = Decimal::Parse(txtUnitPrice->Text);
